...
class BingImageCreatorOfficial:
    ...
    def get_auth_instructions(self):
        ...
        Example:
        generator = BingImageCreatorOfficial(auth_cookie="YOUR_U_COOKIE_VALUE_HERE")
        
        Note: This version uses the official BingImageCreator package which is more reliable.
        """

if __name__ == "__main__":
    # Test the official Bing Image Creator
    logging.basicConfig(level=logging.INFO)
    
    generator = BingImageCreatorOfficial()
    print(generator.get_auth_instructions())
    
    # Uncomment below to test with actual cookie
    # generator = BingImageCreatorOfficial(auth_cookie="YOUR_COOKIE_HERE")
